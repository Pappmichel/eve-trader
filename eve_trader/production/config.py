...
class ProductionConfig:
    ...
    # eligible ready job's own *cap* (the most _allocate_slots_by_coverage
    ...
    # claim slots in stock_coverage order, least-covered first (see
    # engine._allocate_slots_by_coverage). Edited on the Asset-Optimized
